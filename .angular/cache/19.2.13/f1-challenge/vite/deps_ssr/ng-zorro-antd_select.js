...
import {
  ...
  NzEmptyModule
} from "./chunk-TWC5JHCL.js";
import {
  FocusMonitor
} from "./chunk-QWZOCOLM.js";
import {
  NZ_SPACE_COMPACT_ITEM_TYPE,
  NZ_SPACE_COMPACT_SIZE,
  NzSpaceCompactItemDirective,
  takeUntilDestroyed
} from "./chunk-ERKUYTPI.js";
import "./chunk-2TS5BCKM.js";
import {
  NzFormItemFeedbackIconComponent,
  NzFormNoStatusService,
  NzFormStatusService
} from "./chunk-CCBKI3Q5.js";
import {
  CdkConnectedOverlay,
  ...
  getPlacementName,
  slideMotion
} from "./chunk-5RAAKTBB.js";
import "./chunk-HY6YFPZ3.js";
import {
  BACKSPACE,
  DOWN_ARROW,
  ENTER,
  ...
  TAB,
  UP_ARROW
} from "./chunk-TFYDG3RZ.js";
import {
  NzDestroyService,
  cancelRequestAnimationFrame,
  reqAnimFrame
} from "./chunk-VZUAAQTR.js";
import {
  NzOutletModule,
  NzStringTemplateOutletDirective
} from "./chunk-55F5YSCP.js";
import {
  NzIconDirective,
  NzIconModule
} from "./chunk-M3KEDJIF.js";
import "./chunk-5IOQIXFC.js";
import "./chunk-6OAIRWET.js";
import {
  __esDecorate,
  __runInitializers
} from "./chunk-B2WI67Z2.js";
import {
  NzConfigService,
  WithConfig
} from "./chunk-P6FKOLUA.js";
import {
  fromEventOutsideAngular,
  getStatusClassNames,
  isNotNil,
  numberAttributeWithInfinityFallback
} from "./chunk-FBQOJQJS.js";
import {
  Platform,
  _getEventTarget
} from "./chunk-IOBY2HV4.js";
import {
  Directionality
} from "./chunk-CJJJUU22.js";
import "./chunk-DZQQXS2K.js";
import {
...
import "./chunk-K54O4G3Y.js";
import "./chunk-FV2N5334.js";
import "./chunk-PDJ6F3FB.js";
import {
  NgTemplateOutlet
} from "./chunk-7OYSOX6T.js";
import {
  isPlatformBrowser
...
var NzOptionItemComponent = class _NzOptionItemComponent {
  ...
  ngOnInit() {
    fromEventOutsideAngular(this.elementRef.nativeElement, "click").pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe(() => {
      if (!this.disabled) {
        this.ngZone.run(() => this.itemClick.emit(this.value));
      }
    });
    fromEventOutsideAngular(this.elementRef.nativeElement, "mouseenter").pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe(() => {
      if (!this.disabled) {
...
var NzOptionComponent = class _NzOptionComponent {
  ...
  ngOnInit() {
    if (this.nzOptionGroupComponent) {
      this.nzOptionGroupComponent.changes.pipe((0, import_operators.startWith)(true), (0, import_operators.takeUntil)(this.destroy$)).subscribe(() => {
...
var NzSelectComponent = (() => {
  ...
  return class NzSelectComponent2 {
    ...
    listOfValue$ = new import_rxjs.BehaviorSubject([]);
    listOfTemplateItem$ = new import_rxjs.BehaviorSubject([]);
    ...
    ngOnInit() {
      ...
      this.focusMonitor.monitor(this.host, true).pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe((focusOrigin) => {
        if (!focusOrigin) {
          this.focused = false;
          this.cdr.markForCheck();
          this.nzBlur.emit();
      ...
      (0, import_rxjs.combineLatest)([this.listOfValue$, this.listOfTemplateItem$]).pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe(([listOfSelectedValue, listOfTemplateItem]) => {
      ...
      this.nzConfigService.getConfigChangeEventForComponent("select").pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe(() => {
        this.size.set(this.nzSize);
        this.cdr.markForCheck();
      });
      this.dir = this.directionality.value;
      fromEventOutsideAngular(this.host.nativeElement, "click").pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe(() => {
        if (this.nzOpen && this.nzShowSearch || this.nzDisabled) {
          return;
        }
        this.ngZone.run(() => this.setOpenState(!this.nzOpen));
      });
      this.cdkConnectedOverlay.overlayKeydown.pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe((event) => {
    ...
    ngAfterContentInit() {
      if (!this.isReactiveDriven) {
        (0, import_rxjs.merge)(this.listOfNzOptionGroupComponent.changes, this.listOfNzOptionComponent.changes).pipe((0, import_operators.startWith)(true), (0, import_operators.switchMap)(() => (0, import_rxjs.merge)(...[this.listOfNzOptionComponent.changes, this.listOfNzOptionGroupComponent.changes, ...this.listOfNzOptionComponent.map((option) => option.changes), ...this.listOfNzOptionGroupComponent.map((option) => option.changes)]).pipe((0, import_operators.startWith)(true))), (0, import_operators.takeUntil)(this.destroy$)).subscribe(() => {
