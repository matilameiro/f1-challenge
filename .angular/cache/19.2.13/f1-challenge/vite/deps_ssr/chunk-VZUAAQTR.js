...
var NzResizeService = class _NzResizeService {
  ngZone;
  rendererFactory2;
  resizeSource$ = new import_rxjs3.Subject();
  listeners = 0;
  renderer;
  disposeHandle = NOOP;
  handler = () => {
  ...
  subscribe() {
    ...
    return this.resizeSource$.pipe((0, import_operators3.auditTime)(16), (0, import_operators3.finalize)(() => this.unregisterListener()));
  }
  unsubscribe() {
...
var NzDragService = class _NzDragService {
  ...
  requestDraggingSequence(event) {
    ...
    this.currentDraggingSequence = new import_rxjs3.Subject();
    return this.currentDraggingSequence.pipe((0, import_operators3.map)((e) => ({
      x: e.pageX - this.currentStartingPoint.x,
      y: e.pageY - this.currentStartingPoint.y
    })), (0, import_operators3.filter)((e) => Math.abs(e.x) > this.draggingThreshold || Math.abs(e.y) > this.draggingThreshold), (0, import_operators3.finalize)(() => this.teardownDraggingSequence()));
  }
...
var NzBreakpointService = class _NzBreakpointService {
  ...
  constructor(resizeService, mediaMatcher) {
    ...
    this.resizeService.subscribe().pipe((0, import_operators3.takeUntil)(this.destroy$)).subscribe(() => {
    });
  }
  ngOnDestroy() {
    this.destroy$.next();
  ...
  subscribe(breakpointMap, fullMap) {
    if (fullMap) {
      ...
      return this.resizeService.subscribe().pipe((0, import_operators3.map)(get), (0, import_operators3.startWith)(get()), (0, import_operators3.distinctUntilChanged)((x, y) => x[0] === y[0]), (0, import_operators3.map)((x) => x[1]));
    } else {
      const get = () => this.matchMedia(breakpointMap);
      return this.resizeService.subscribe().pipe((0, import_operators3.map)(get), (0, import_operators3.startWith)(get()), (0, import_operators3.distinctUntilChanged)());
    }
  }
...
var NzDestroyService = class _NzDestroyService extends import_rxjs3.Subject {
  ngOnDestroy() {
    this.next();
    this.complete();
  }
...
//# sourceMappingURL=chunk-VZUAAQTR.js.map
